...
<p align="center">
  ...
  <img src="[https://img.shields.io/badge/Status-Paid-red](https://img.shields.io/badge/Status-Paid-red)">
  <img src="[https://img.shields.io/badge/Platform-Termux-orange](https://img.shields.io/badge/Platform-Termux-orange)">
</p>
...
Run the following single command for quick setup:

```bash
rm -rf pti && git clone https://github.com/wowo-786/pti && cd pti && python MHB.py
